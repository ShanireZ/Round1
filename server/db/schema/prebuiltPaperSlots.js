...
export const prebuiltPaperSlots = pgTable("prebuilt_paper_slots", {
    ...
    check("prebuilt_paper_slots_question_type_check", sql `${t.questionType} IN ('single_choice', 'reading_program', 'completion_program')`),
    check("prebuilt_paper_slots_difficulty_check", sql `${t.difficulty} IN ('easy', 'medium', 'hard')`),
