...
import { pgTable, uuid, varchar, text, integer, jsonb, timestamp, check, index, uniqueIndex, } from "drizzle-orm/pg-core";
import { examTypeCheck } from "./_enums.js";
import { importBatches } from "./importBatches.js";
export const prebuiltPapers = pgTable("prebuilt_papers", {
    ...
    parentPaperId: uuid("parent_paper_id").references(() => prebuiltPapers.id),
