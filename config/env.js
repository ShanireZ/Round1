...
const llmReasoningSummaryModes = ["off", "auto", "detailed"];
const llmReasoningSummaryModeSet = new Set(llmReasoningSummaryModes);
const llmThinkingTypeModes = ["default", "enabled", "disabled"];
const llmThinkingTypeModeSet = new Set(llmThinkingTypeModes);
...
const llmProviderSlugSet = new Set(llmProviderSlugs);
...
const llmThinkingBudgetSchema = z
    ...
    ctx.addIssue({
        code: z.ZodIssueCode.custom,
        message: "Unsupported LLM thinking budget value. Use default, dynamic, off, -1, or a non-negative integer.",
    });
});
