...
| `docs/_inventory/` | `scripts/reportDocsInventory.ts` 生成的文档盘点结果 |
...
没有状态头的旧计划必须出现在 `docs/_inventory/docs-inventory.md` 的缺口列表中，直到被逐一补齐或登记为例外。
...
- 标准目录每次重大架构决策后复核一次。
- 每次 docs 布局、计划收口、问题关闭或批量清理后刷新 `docs/_inventory/`。
