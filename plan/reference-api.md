...
| `/api/v1/classes/join`、`/api/v1/coach/**`                                                                                                                                                                                                                                   | 现状契约 | 当前已挂载教练后端 slice：班级、成员、邀请、多教练、assignment、已发布预制卷选择器、群体热力图、题型统计和学生下钻报表；`/coach/classes`、`/coach/classes/:id`、`/coach/assignments`、`/coach/report` 前端已接入真实页面，并已纳入 UI visual audit |
...
| `GET`    | `/api/v1/coach/prebuilt-papers`                            | 已发布预制卷选择器（创建任务用）                                                                                            | coach+                   |
