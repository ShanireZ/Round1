...
| `/api/v1/classes/join`、`/api/v1/coach/**`                                                                                                                                                                                                                                   | 现状契约 | 当前已挂载教练后端 slice：班级、成员、邀请、多教练、assignment、已发布预制卷选择器、群体热力图、题型统计和学生下钻报表；`/coach/report`、`/coach/classes`、`/coach/assignments` 前端已接入，`CoachClassDetail` 仍需继续收口 |
