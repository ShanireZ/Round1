...
- question bundle 标准产物统一放入 `papers/<year>/YYYY-MM-DD-<questionType>-<count>.json`
- prebuilt paper bundle 标准产物仍可使用 `paper-packs.json`
...
**Outputs**
- UTF-8 JSON file under `papers/<year>/`
- Validated question bundle filename format: `YYYY-MM-DD-<questionType>-<count>.json`
