...
- `docs/` now has a top-level index, maintenance rules, this issue register, and generated inventory.
...
| DOC-003 | open | docs root | user request on 2026-05-03 | Topic docs existed without a stable docs entry point or cleanup method. | Keep `docs/README.md`, `docs/maintenance.md`, and `docs/_inventory` updated with every docs layout change. | Two consecutive doc changes update inventory and do not add unindexed root docs. |

## Closed Items

| id | closed at | summary | evidence |
| --- | --- | --- | --- |
| DOC-000 | 2026-05-03 | Established the docs maintenance baseline. | `docs/README.md`, `docs/maintenance.md`, `scripts/reportDocsInventory.ts`, and `docs/_inventory/docs-inventory.md`. |
